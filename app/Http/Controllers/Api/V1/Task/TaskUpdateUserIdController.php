...
use App\Core\Task\DTO\Factories\TaskUpdateUserIdDTOFactory;
...
use App\Http\Requests\TaskUpdateUserIdRequest;
use App\Http\Resources\TaskResource;
use Illuminate\Auth\Access\AuthorizationException;
use Illuminate\Support\Facades\Log;
use Symfony\Component\HttpFoundation\JsonResponse;

class TaskUpdateUserIdController
{
    protected $useCase;

    public function __construct(TaskUpdateUserIdUseCaseInterface $useCase)
    {
        $this->useCase = $useCase;
    }

    public function __invoke(TaskUpdateUserIdRequest $request, int $id): JsonResponse
    {
        try {
            $dto = TaskUpdateUserIdDTOFactory::updateUserIdFromArray([
                'id' => $id,
